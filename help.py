def help(_role):
    ...
    if _role == "admin": # fungsi yg hanya bisa diakses admin
        ...
        print("3. tambah game           - Untuk menambah game yang dijual pada toko")
        print("4. list game toko        - Untuk melihat list game yang dijual pada toko")
        print("5. ubah game             - Untuk mengubah informasi game dengan informasi baru")
        print("6. ubah stok             - Untuk mengubah stok sebuah game pada toko")
        print("7. search game at store  - Untuk mendapatkan informasi game yang ada di toko")
        ...
        print("2. list game toko        - Untuk melihat list game yang dijual pada toko")
        ...
        print("6. search game at store  - Untuk mendapatkan informasi game yang ada di toko")
